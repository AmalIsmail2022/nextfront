  ...
  useEffect(() => {
    window.addEventListener("scroll", () => {
      if (window.scrollY > 100) {
        headerRef.current.style.background = "#001524";
                ...
                <div className="menu absolute top-[80px] h-fit transition duration-500 bg-white w-[100%] animate-pulse z-5 ">
                  <div className="flex  gap-[20px] justify-between mx-[40px]">
                    <div className="my-[25px]  flex ">
                      ...
                      <Link  href="/products" className="xl:w-[300px] lg:w-[200px] md:w-[150px] sm:w-[100px] h-full ">
                        <Image
                          src={img2}
                          alt="fff"
                      ...
                      <Link  href="/products" className="xl:w-[300px] lg:w-[200px] md:w-[150px] h-full sm:w-[100px]">
                        <Image
                          src={img1}
                          alt="fff"
                          className="w-full cursor-pointer"

...
function Sec6CardContainer() {
  return (
    <div className=" grid xl:grid-cols-5 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2  gap-[40px] w-full mx-auto pb-[100px] px-[20px]">
      <motion.div
      ...
      <motion.div
        ...
        viewport={{ once: false, amount: 0.8 }}
      >
        <Card img={img9} title={"Portable Electric Heater"} price={"$150.00"} />
      </motion.div>
...
export default Sec6CardContainer;
